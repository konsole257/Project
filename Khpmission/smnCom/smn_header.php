...
//-->
	...
	<div id="header">
		<div class="hLogo"><a href="/"><img src="/images/common/top_logo1.gif" alt="한국성민선교회"></a></div>
		<div class="hMenu">
			<strong>
			...
			<a href="/" style="font-size:11px;font-family: '돋움', Dotum, '굴림', Gulim, AppleGothic, Sans-serif;color:#5a5a5a;">ENGLISH</a>
			</strong>
		</div>
		<div class="hVisual">
			<img src="/images/main/top_img.jpg" alt="The Korea Holy People's Mission">
		</div>
	</div>
