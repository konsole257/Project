...
<!-- <div class="nodata">
    ...
    <a href="{{dirRoot}}/{{prop.parentPage}}/{{prop.page}}.asp" class="btn-fill-blue-middle btn-link">공시 이동</a>
</div> -->
<!-- // nodata : 검색 결과 없을경우 -->

<div class="bbs-list-area">
	{{include('./components/skip.html', {"prop": {"id": "list-area-end","text": "공시 건너뛰기"}})}}

    <table class="bbs-list-table">
        <caption class="hide">공시</caption>
