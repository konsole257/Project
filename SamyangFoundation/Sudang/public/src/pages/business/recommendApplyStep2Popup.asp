<h3 class="tit">수당상 추천</h3>

<div class="menu">
    <div class="inner">
        <a href="#claimant">1. 후보자 정보</a>
        <a href="#result">2. 후보자 공적</a>
        ...
        <div class="confirm-file active" onclick="fn.removeActive('.confirm-file');">
            ...
            <div class="txt-info">
                <div>
                    <strong>
                    수당재단  수당상 추천 시 아래 필수 첨부파일을 확인해 주세요.<br>
                    미 첨부 시 수당상 추천이 불가합니다.
                    </strong>

                    <p>
                        <strong class="bullet-black">후보자 증명사진 1부</strong>
                        <span class="depth2">- 최근 6개월 이내 촬영된 사진</span>
                    </p>
                    <p>
                        <strong class="bullet-black">후보자 추천서 1부</strong>
...
<div class="form">
    <form>
            ...
            <table class="form-table">
                ...
                <tbody>
                    <tr>
                        <td rowspan="4">
                            <span class="file file-picture">
								...
								<span class="btn-small-fill-green btn-file" onclick="fn.fileBtn(this);">사진첨부</span>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" title="자택 전화번호 입력" placeholder="숫자만 입력해 주세요.">
                        </td>
                    </tr>
        ...
        <fieldset class="form-fieldset">
            ...
            <table class="form-table">
                <caption class="hide">소속명 (근무처), 부서(학과), 소속기관 전화번호, 직위</caption>
                ...
                <tbody>
                    <tr>
                        <th><span>소속명 (근무처)</span></th>
                        <td colspan="3">
                            <input type="text" title="소속명 (근무처) 입력" placeholder="ex) 삼양대학교">
                        </td>
                    </tr>
            ...
            <script>
                ...
                var achieveListAdd = function(){
                    ...
                    var achieveList = '';
                        ...
                        achieveList += '        <col style="width:460px;">';
                        achieveList += '        <col style="width:180px;">';
                        achieveList += '        <col style="width:380px;">';
                        achieveList += '    </colgroup>';
                        achieveList += '    <tbody>';
                        achieveList += '        <tr>';
            ...
            <script>
                ...
                var careerListAdd = function(){
                    ...
                    var careerList = '';
                        ...
                        careerList += '        <col style="width:460px;">';
                        careerList += '        <col style="width:180px;">';
                        careerList += '        <col style="width:380px;">';
                        careerList += '    </colgroup>';
                        careerList += '    <tbody>';
                        careerList += '        <tr>';
        ...
        <fieldset class="form-fieldset result-fieldset">
            ...
            <div class="txt-area">
                <p class="bullet-gray">국내외 주요상의 수상 경력을 입력해 주세요.</p>
            </div>

            <ul class="result-list">
                <li>
                    <strong>실적<span>1</span></strong>
                    <table class="form-table">
                        <caption class="hide">시상일, 시상자, 수상내용</caption>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <span class="datepicker">
                                        <input type="text" title="시상일 입력">
                                    </span>
                                </td>

                                <th><span>시상자(기관)</span></th>
                                <td>
                                    <input type="text" title="시상자 입력">
                                </td>
                            </tr>

                            <tr>
                                <th><span>수상내용</span></th>
                                <td colspan="3">
                                    <input type="text" title="수상내용 입력">
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <script>
                ...
                var resultListAdd = function(){
                    ...
                    var resultList = '';
                        ...
                        resultList += '    <tbody>';
                        resultList += '        <tr>';
                        resultList += '            <th><span>시상일</span></th>';
                        resultList += '            <td>';
                        resultList += '                <span class="datepicker">';
                        resultList += '                    <input type="text" title="시상일 입력">';
                        resultList += '                </span>';
                        resultList += '            </td>';
                        resultList += '            <th><span>시상자(기관)</span></th>';
                        resultList += '            <td>';
                        resultList += '                <span class="datepicker">';
                        resultList += '                    <input type="text" title="시상자 입력">';
                        resultList += '                </span>';
                        resultList += '            </td>';
                        resultList += '        </tr>';
                        resultList += '        <tr>';
                        resultList += '            <th><span>수상내용</span></th>';
                        resultList += '            <td colspan="3">';
                        resultList += '                <input type="text" title="수상내용 입력">';
                        resultList += '            </td>';
                        resultList += '        </tr>';
                        resultList += '    </tbody>';
                        resultList += '</table>';
        ...
        <!-- 후보자 공적 // -->
        <fieldset id="result" class="form-fieldset service-fieldset">
            <legend>후보자 공적</legend>

            <ul class="service-list">
                <li>
                    <p class="question-service">공적 대표 인용(두줄 이내로 공적 내용을 입력해 주세요.)</p>
                    <textarea class="textarea-service" title="대학생활 중 학습계획 입력" placeholder="텍스트를 입력해 주세요."></textarea>
                </li>
                <li>
                    <p class="question-service">공적 요약(대표적인 업적 위주로 간략하게 요약하여 입력해 주세요.)</p>
                    <textarea class="textarea-service" title="과외활동계획 입력" placeholder="텍스트를 입력해 주세요."></textarea>
                </li>
                <li>
                    <p class="question-service">공적 상세 내용(대표적인 업적 위주로 상세하게 입력해 주세요.)</p>
                    <textarea class="textarea-service2" title="대학 졸업 후 사회 진출 포부 중 학습계획 입력" placeholder="텍스트를 입력해 주세요."></textarea>
                </li>
            </ul>
        </fieldset>
        <!-- // 후보자 공적 -->
        ...
        <!-- 수당상 후보자 추천서 // -->
        <fieldset class="form-fieldset recommend-fieldset">
            <legend>수당상 후보자 추천서</legend>
            ...
            <table class="form-table">
                <caption class="hide">수당상 후보자 첨부파일</caption>
                ...
                <tbody>
                    <tr>
                        <th class="required"><span>수당상 후보자 첨부파일</span></th>
                        <td colspan="3">
                            <span class="file file-recommend">
                                ...
                                <input type="file" title="수당상 후보자 파일첨부" onchange="fn.file(this);">
                            </span>
        ...
        <fieldset id="policy" class="form-fieldset policy-fieldset">
            ...
            <p class="txt">수당상 후보자를 위와 같이 추천합니다.</p>
    ...
    팝업
    <br>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-recommendApplyAgree');">동의하지않음</button>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-recommendApplyRequiredFile');">필수 첨부파일</button>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-recommendApplyTemporary');">임시저장</button>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-recommendApplyChecked');">최종제출 선택 후 임시저장</button>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-recommendApply');">최종제출</button>
</div>
...
{{include('./components/popup.html', {
    "prop": {
        "id": "popup-recommendApplyAgree",
        "class": "popup-recommendApplyAgree",
        "type": "alert",
        "content": "./pages/popup/recommendApplyAgree.asp"
    }
})}}
<!-- // 팝업 : 동의하지않음 -->
...
{{include('./components/popup.html', {
    "prop": {
        "id": "popup-recommendApplyRequiredFile",
        "class": "popup-recommendApplyRequiredFile",
        "type": "alert",
        "content": "./pages/popup/recommendApplyRequiredFile.asp"
    }
})}}
<!-- // 팝업 : 필수 첨부파일 -->
...
{{include('./components/popup.html', {
    "prop": {
        "id": "popup-recommendApplyTemporary",
        "class": "popup-recommendApplyTemporary",
        "type": "alert",
        "content": "./pages/popup/recommendApplyTemporary.asp"
    }
})}}
<!-- // 팝업 : 임시저장 -->
...
{{include('./components/popup.html', {
    "prop": {
        "id": "popup-recommendApplyChecked",
        "class": "popup-recommendApplyChecked",
        "type": "alert",
        "content": "./pages/popup/recommendApplyChecked.asp"
    }
})}}
<!-- // 팝업 : 최종제출 선택 후 임시저장 -->
...
{{include('./components/popup.html', {
    "prop": {
        "id": "popup-recommendApply",
        "class": "popup-recommendApply",
        "type": "confirm",
        "content": "./pages/popup/recommendApply.asp"
    }
})}}
<!-- // 팝업 : 최종제출 -->
