                    ...
                    <tr>
                        ...
                        <td>
                            <div class="bundle bundle-number">
                                <input type="number" title="한국장학재단 고객번호 입력" class="input-number" pattern="\d*" maxlength="10" oninput="fn.numberMaxLength(this);" placeholder="숫자만 입력해 주세요. (10자리)" value="123456789">
            ...
            <table class="form-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" title="취득학점 입력" placeholder="ex) 140" value="18">
                        </td>
                    </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <div class="bundle bundle-company">
                                        ...
                                        <label><input type="checkbox" onchange="chkToggle(this);" checked><span>해당없음</span></label>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
