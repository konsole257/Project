...
<div class="form">
    ...
    팝업
    <br>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-researchImpossible');">신청 불가</button>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-researchNodata');">장학생 신청 이력 없음</button>
</div>
