    ...
    <div class="inner">
        ...
        <div class="confirm-file active" onclick="fn.removeActive('.confirm-file');">
            ...
            <div class="txt-info">
                <div>
                    <strong>
                    양영재단 장학생 신청 시 아래 필수 파일첨부을 확인해 주세요.<br>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="bundle bundle-chn">
                                <input type="text" title="성명(한자) 입력" class="input-chn" value="紅吉東">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="datepicker">
                                <input type="text" title="생년월일 입력" value="2020.07.03" readonly>
                            </span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="bundle bundle-number">
                                <input type="number" title="한국장학재단 고객번호 입력" class="input-number" pattern="\d*" maxlength="10" oninput="fn.numberMaxLength(this);" placeholder="숫자만 입력해 주세요. (10자리)" value="1234567890">
            ...
            <table class="form-table">
                ...
                <tbody>
                    <tr>
                        <th><span>학교</span></th>
                        <td>
                            <input type="text" title="학교 입력" placeholder="ex) 삼양대학교" value="삼양대학교">
                        </td>

                        <th><span>학과</span></th>
                        <td>
                            <input type="text" title="학과 입력" placeholder="ex) 바이오공학과" value="바이오공학과">
                        </td>
                    </tr>
            ...
            <table class="form-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" title="취득학점 입력" placeholder="ex) 17" value="18">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" title="학점 입력" placeholder="ex) 4.3" value="4.3">
                        </td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    <tr>
                        <th><span>사유</span></th>
                        <td colspan="3">
                            <input type="text" title="사유 입력" placeholder="ex) 휴학" value="휴학">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <span class="file file-result">
                                <input type="text" onclick="fn.fileBtn(this);" value="2019년_홍길동 성적증명서.pdf">
								<span class="btn-small-fill-blue btn-file" onclick="fn.fileBtn(this);">파일선택</span>
							    <input type="file" title="전체학기 성적증명서 파일첨부" value="2019년_홍길동 성적증명서.pdf" onchange="fn.file(this);">
							</span>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <span class="file file-recommend">
                                <input type="text" onclick="fn.fileBtn(this);" value="홍길동_전체학기 학교장추전서.pdf ">
								<span class="btn-small-fill-blue btn-file" onclick="fn.fileBtn(this);">파일선택</span>
							    <input type="file" title="통장 사본 파일첨부" value="홍길동_전체학기 학교장추전서.pdf " onchange="fn.file(this);">
							</span>
                    ...
                    <table class="form-table">
                        ...
                        <tbody>
                            <tr>
                                <th><span>관계</span></th>
                                <td>
                                    <input type="text" title="관계 입력" value="부">
                                </td>

                                <th><span>성명</span></th>
                                <td>
                                    <input type="text" title="성명 입력" value="홍서범">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="datepicker">
                                        <input type="text" title="생년월일 입력" readonly value="1952.06.28">
                                    </span>
                                </td>

                                <th><span>직업</span></th>
                                <td>
                                    <input type="text" title="직업 입력" value="전업주부">
                                </td>
                            </tr>
            ...
            <script>
                ...
                var familyListAdd = function(){
                    ...
                    var familyList = '';
                        ...
                        familyList += '        <col style="width:400px;">';
                        familyList += '        <col style="width:180px;">';
                        familyList += '        <col style="width:320px;">';
                        familyList += '    </colgroup>';
                        familyList += '    <tbody>';
                        familyList += '        <tr>';
