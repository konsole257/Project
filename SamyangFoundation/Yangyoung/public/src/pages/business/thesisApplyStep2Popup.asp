...
<div class="form">
            ...
            <table class="form-table">
                ...
                <tbody>
                    <tr>
                        <th><span>신청일</span></th>
                        <td>
                            <input type="text" title="신청일 입력" value="2020.06.29">
                        </td>
    ...
    팝업
    <br>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-thesisApplyAgree');">동의하지않음</button>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-thesisApply');">최종제출</button>
</div>
