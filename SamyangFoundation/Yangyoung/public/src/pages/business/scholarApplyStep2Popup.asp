...
<div class="form">
    <form>
            ...
            <table class="form-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" title="취득학점 입력" placeholder="ex) 17">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" title="평균학점 입력" placeholder="ex) 4.3">
                        </td>
                    </tr>
                </tbody>
        ...
        <div class="income-area">
            ...
            <div class="tab-menu">
                <a href="#tab-income" class="active">한국장학재단 소득 분위</a>
                <a href="#tab-parent">부모 각각의 지방세 세목별 과세/건강 · 장기요양보험료</a>
            </div>

            <!-- 한국장학재단 소득 분위 // -->
            <div id="tab-income" class="tab-contents active">
                <fieldset class="form-fieldset income-fieldset">
                    <legend>한국장학재단 소득 분위</legend>
            ...
            <div id="tab-parent" class="tab-contents">
                <fieldset class="form-fieldset parent-fieldset">
                    <legend>부모(父母) 각각의 지방세 세목별 과세</legend>
                ...
                <!-- 부모(父母) 각각의 건강보험료 // -->
                <fieldset class="form-fieldset parent-fieldset">
                    <legend>부모(父母) 각각의 건강 · 장기요양보험료</legend>
    ...
    팝업
    <br>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-applyAgree');">동의하지않음</button>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-applyRequiredFile');">필수 첨부파일</button>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-applyTemporary');">임시저장</button>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-applyChecked');">최종제출 선택 후 임시저장</button>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-apply');">최종제출</button>
</div>
