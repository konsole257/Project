...
<div class="menu">
    <div class="inner">
        <a href="#claimant">1. 연구비지원 신청</a>
        <a href="#career">2. 신청인 이력사항</a>
            ...
            <div class="txt-info">
                <div>
                    ...
                    <p>
                        ...
                        <span class="depth2">- 연구비지원비 수령 계좌 통장 사본</span>
                    </p>
                    <p>
...
<div class="form">
    ...
    팝업
    <br>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-researchApplyAgree');">동의하지않음</button>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-researchApplyRequiredFile');">필수 첨부파일</button>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-researchApplyTemporary');">임시저장</button>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-researchApplyChecked');">최종제출 선택 후 임시저장</button>
    <button type="button" class="btn-fill-small" onclick="fn.popupOpen('#popup-researchApply');">최종제출</button>
</div>
