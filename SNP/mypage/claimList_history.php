		...
		<div id="contents">
			...
			<div class="body">
				...
				<div class="tab-menu sub">
					<!-- 2019.03.15// -->
					<a href="/mypage/claimList_history.php" class="active">신청내역</a>
					<a href="/mypage/claimList.php">취소/교환/반품 신청</a>
					<!-- //2019.03.15 -->
				</div>
				<!-- // sub tab -->
				...
				<table class="tbl-type1">
					<caption class="hide">신청내역 목록</caption>
					<colgroup>
