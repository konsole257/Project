...
<?
	...
	$path2Tit = "주문배송 조회";
	$path1Href = "";
	$path2Href = "/mypage/oderView_nonmember.php";
		...
		<div id="contents">
			...
			<div class="body">
				...
				<div class="order-step">
					<div><span>주문<br>접수</span></div>
					<div><span>결제<br>완료</span></div>
					<div><span>상품<br>준비중</span></div>
					<div class="active"><span>출고<br>완료</span></div>
				...
				<div class="order-view">
					<div class="left-area">
						...
						<div class="orderproduct">
							<h3>
								...
								<div class="delivery">운송장번호<span>306064007852</span><a href="javascript:void(0);" class="btn smaller fill black" onclick="fn.popupWinOpen('/index.php','테스트팝업','800','400')">배송 조회</a></div>
							</h3>
					...
					<div class="right-area">
						...
						<!-- btn // -->
						<!--<div class="btn-area">
							<a href="#" class="btn fill black">교환/반품 신청</a>
						</div>-->
						<!-- // btn -->
						<!-- //2019.03.15 -->
					</div>
