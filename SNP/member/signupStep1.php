...
<div id="wrap" class="sub <?= $shopName ?>">
				...
				<form class="form-area">
					<fieldset>
						...
						<div class="input-area">
							<div>
								<div>
									<span class="field-input join">
										<span class="inner">
											<label><input type="radio" class="snp" name="join" checked><span><img src="/pjtCom/pc/images/sub/icon_join_snp.png" alt="SNP MALL">회원가입</span></label>
											<label><input type="radio" class="naver" name="join"><span><img src="/pjtCom/pc/images/sub/icon_join_naver.png" alt="NAVER">간편가입</span></label>
											<label><input type="radio" class="kakao" name="join"><span><img src="/pjtCom/pc/images/sub/icon_join_kakao.png" alt="KAKAO">간편가입</span></label>
											<label><input type="radio" class="facebook" name="join"><span><img src="/pjtCom/pc/images/sub/icon_join_facebook.png" alt="FACEBOOK">간편가입</span></label>
										</span>
									</span>
								</div>
							</div>
					...
					<fieldset>
						...
						<p class="txt">SNP 회원가입 및 다양한 서비스 이용을 위해 아래 약관에 대한 안내를 읽고 동의해주세요.</p>

						<div class="terms-area">
							<div class="required">
								<label><input type="checkbox" data-name="check"><span></span></label>
								<a href="#" onclick="fn.popupOpen('#terms-service')">회원이용 약관 동의</a>
								<span class="state">(필수)</span>
							</div>
							<div class="required">
								<label><input type="checkbox" data-name="check"><span></span></label>
								<a href="#" onclick="fn.popupOpen('#terms-privacy')">개인정보수집 및 이용 동의</a>
								<span class="state">(필수)</span>
							</div>
							<!-- <div>
								<label><input type="checkbox" data-name="check"><span></span></label>
								<a href="#" onclick="fn.popupOpen('#terms-product')">상품소개 등을 위한 개인정보 처리 동의</a>
								<span class="state">(선택)</span>
							</div> -->
						</div>

						<label class="agree-all"><input type="checkbox" data-name="all"><span>모든 약관에 동의합니다.</span></label>

						<!--
							팝업 호출
							- 필수 약관 동의 : fn.popupOpen('#required');
						-->
						<button type="button" class="btn big fill black btn-agree">동의하고 진행</button>
					</fieldset>
				</form>
			</div>
		</div>
	...
	<div id="terms-service" class="popup terms-service">
		<div class="inner">
			...
			<div class="contents">
				<div class="txt">
					<div class="scrollbar">
						인터넷 쇼핑몰 『 (주)에스디생명공학 사이버 몰』회원 약관<br><br>

						제1조(목적)<br>
						이 약관은 (주)에스디생명공학 회사(전자상거래 사업자)가 운영하는 (주)에스디생명공학 사이버 몰(이하 "몰"이라 한다)에서 제공
						하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의
						무 및 책임사항을 규정함을 목적으로 합니다.<br><br>

						 「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」<br><br>

						제2조(정의)<br>
						①"몰" 이란 (주)에스디생명공학 회사가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴
						...
						번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 (주)에스디생명공학 사이버몰의 초기 서비스화면(전면)
						...
						고 그 이전에 이미 체결된 계약에 대해서는 개정전의 약관조항이 그대로 적용됩니다. <br>
						다만 이미 계
						...
						실이 없음을 입증하는 경우에는 그러하지 아니합니다.<br><br>
						...
						고, 회원등록 말소전에 최소한 30일 이상의 기간을 정하여 소명할 기회를 부여합니다.<br><br>
						...
						수 있었던 날부터 30일 이내에 청약철회 등을 할 수 있습니다.<br><br>
						...
						는지를 이용자가 알기 쉽도록 명확하게 표시합니다.<br><br>
						...
						달성한 때에는 당해 개인정보를 지체없이 파기합니다.<br><br>
						...
						"몰"에 통보하고 "몰"의 안내가 있는 경우에는 그에 따라야 합니다.<br><br>
						...
						경우에는 그 거래에 대한 보증책임을 지지 않습니다.<br><br>
						...
						본 약관은 2009년 [11월 18일]부터 적용됩니다.<br>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- 팝업 : 상품소개 등을 위한 개인정보 처리 동의 // -->
	<!-- <div id="terms-product" class="popup terms-product">
		<div class="inner">
			<header class="header">
				<h2 class="tit">상품소개 등을 위한 개인정보 처리 동의</h2>
			...
			<div class="contents">
				<div class="txt">
					<div class="scrollbar">
						* 소비자권익보호에 관한 사항<br>
						- 동의거부권 및 유의사항<br>
						: 홈페이지를 통한 각종 이벤트 참여, 부가서비스 및 신상품 안내 등을 제공받고자 하시는 경우 동의해주시기 바랍니다.<br>
						이에 대한 동의가 없더라도 홈페이지 회원가입이 가능함을 알려드립니다.<br><br>

						- 개인정보 제공동의 철회<br>
						: 개인정보 제공 및 이용에 동의한 이후에도 전화, 서면, 홈페이지 등을 통해 개인정보의 제공 동의를 철회할 수 있습니다.
					</div>
				</div>
			</div>
		</div>
