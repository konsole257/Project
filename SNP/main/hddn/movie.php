<section class="con5">
	<!-- 비디오 등록시 // -->
	<h2 class="tit"><img src="/pjtCom/pc/images/main/hddn/con5_tit.png" alt="MOVIE IN ITEM"></h2>
			...
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="vidio-area">
						...
						<img src="/pjtCom/pc/images/temp/hddn/movie.jpg" alt="" class="img">
					</div>
					...
					<div class="swiper-container con5-swiper2">
						<ul class=" swiper-wrapper product-list">
							<li class="swiper-slide">
								<a href="#">
									<ul class="flag">
										<li><span style="color:#000; border:1px solid #000; background:#fff;">Bestseller</span></li>
										<li><span style="color:#eb0f29; border:1px solid #f5b4bb; background:#fff;">Hot Item</span></li>
										<li><span style="color:#fff; background:#b172f4;">디렉터파이 선정<br>착한 보습크림</span></li>
									</ul>
	...
	<!-- 이미지 등록시 : 2019.04.08 : 추가 // -->
	<!-- <div class="img-area">
		<img src="/pjtCom/pc/images/temp/hddn/movie_img.jpg" alt="" class="img">
	</div> -->
	<!-- // 이미지 등록시 -->
