<section class="con2">
	<h2 class="tit"><img src="/pjtCom/pc/images/main/msolic/con2_tit.png" alt="Like it"></h2>

	<ul class="product-list">
		<li class="small">
			<a href="#">
				<img src="/pjtCom/pc/images/temp/msolic/likeit_285x480.jpg" alt="" class="img">
			</a>
		</li>
		...
		<li class="midium">
			<a href="#">
				<img src="/pjtCom/pc/images/temp/snp/likeit_590x380.jpg" alt="" class="img">
			</a>
		</li>
	</ul>

	<div class="icon heel"></div>
</section>
