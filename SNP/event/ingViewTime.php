			...
			<div class="body">
				...
				<div class="view">
					...
					$(document).ready(function(){
						//fn.countDownTimer('종료시간');
						fn.countDownTimer('2019-06-25 15:00:00');
					});
					</script>
				...
				<div class="planpro">
					...
					<ul class="product-list">
						...
						<li>
							<ul class="flag">
								<!-- 2019.03.15// -->
								<li><span style="color:#9e9e9e; border:1px solid #cfcfcf; background:#e2e2e2;">일시품절</span></li><!-- 관리자에서 style등록 -->
								<li><span style="color:#eb0f29; border:1px solid #f5b4bb; background:#fff;">품절임박</span></li><!-- 관리자에서 style등록 -->
								<!-- 2019.03.15// -->
								<!-- 2019.03.15// -->
								<li class="timesale"><span>타임세일</span></li>
								<!-- 2019.03.15// -->
							</ul>
