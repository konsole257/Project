		...
		<div id="contents">
			...
			<div class="body">
				...
				<div class="planpro">
					<!-- 2019.07.24 : 태그 추가 // -->
					<div class="sort-area">
						<button type="button" onclick="fn.toggleClass('.sort-area')">전체상품 보기</button>

						<div class="sort">
							<a href="/product/productList.php" class="active">전체상품 보기</a><!-- 현재 페이지 class="active" -->
				...
				<!-- 상품리스트 // -->
				<div class="planpro">
					<h4>수분충전,완벽보습,피부진정 Multi-care</h4>
