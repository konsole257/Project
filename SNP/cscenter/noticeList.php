		...
		<div id="contents">
			...
			<div class="body">
				...
				<ul class="list">
					<li class="notice">
						<a href="#">
							<strong><em>공지</em>네이버페이 주문/문의 장애 공지 네이버페이 주문/문의 장애 공지 네이버페이 주문/문의 장애 공지 네이버페이 주문/문의 장애 공지 네이버페이 주문/문의 장애 공지 네이버페이 주문/문의 장애 공지</strong>
							<span>2018.12.27</span>
						</a>
					</li>
					<li class="notice">
						<a href="#">
							<strong><em>공지</em>※SNP 공식몰 사이트 점검으로 인한 이용 중단 안내※</strong>
							<span>2018.12.27</span>
						</a>
					</li>
					<li>
						<a href="#">
							<strong><em class="new">New</em>SNP 리뷰 적립금 제도가 2019년 2월 부터 달라집니다!</strong>
							<span>2018.12.27</span>
						</a>
					</li>
					<li>
						<a href="#">
							<strong>SNP 리뷰 적립금 제도가 2019년 2월 부터 달라집니다!</strong>
							<span>2018.12.27</span>
						</a>
					</li>
					<li>
