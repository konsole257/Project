		...
		<div id="contents">
			...
			<section>
                <div class="subject_area">
                    <h3>Unit 18.7 현재완료_날씨_일반동사_긍정</h3>
                    <h4>주관식</h4>
				...
				<div class="result"><!-- try again : class="result tryagain", not bad : class="result notbad", excellent일때 : class="result excellent", master일때 : class="result master" -->
					<div class="output_area">
						<p class="unit">Unit 5.3 be동사1_날씨_현재_긍정</p>
					</div>
					...
					<div class="txt_area">
						...
						<div>
							<a href="#" class="btn box tryagain">전체 문제 재도전</a>
							<a href="#" class="btn box tryagain">틀린 문제 재도전</a>
							<a href="#" class="btn box tryagain">그냥 진도 나갈래요</a>
						</div>
