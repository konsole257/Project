...
<body class="sub">
	...
	<!-- wrap -->
	<main id="wrap" class="policy terms">
		<div id="contents" class="">

			<div class="tit_area">
				<h2 class="tit"><span>Agreement of utilization</span>이용약관</h2>
			</div>

			<div class="policy_area">
				<input type="radio" name="lang" id="lang_kor" class="rdo_type1" checked><label for="lang_kor">한국어</label>
				<input type="radio" name="lang" id="lang_eng" class="rdo_type1"><label for="lang_eng">English</label>

				<div class="contents kor">
