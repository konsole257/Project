	...
	<main id="wrap" class="member join">
		<div id="contents">
			...
			<div class="join_step1">
				...
				<h2 class="tit"><span>일반</span>회원가입</h2>
						...
						<form>
							<fieldset class="required_field">
								...
								<div>
									...
									<input type="text" placeholder="Full name" title="이름 입력" class="txt_type1 write_name"><!-- 수정 : 2018.06.07_2 -->
									...
									<p class="txt_alert">국,영문 20자 이내 입력</p><!-- 추가 : 2018.06.07_2 -->
								</div>
								<div>
									<span class="write_tit">ID</span><!-- 추가 : 2018.05.17 -->
									<input type="text" placeholder="ID (숫자, 영문 조합으로 6자리 이상)" title="아이디 입력" class="txt_type1 write_id">
									<button type="button" class="btn_check">중복확인<span>(Check)</span></button>
								</div>
								<div>
									<span class="write_tit">Password</span><!-- 추가 : 2018.05.17 -->
								...
								<div>
									<span class="write_tit">Re-enter Password</span><!-- 추가 : 2018.05.17 -->
							...
							<fieldset class="add_field">
								...
								<div>
									<span class="write_tit">Date of Birth</span><!-- 추가 : 2018.05.17 -->
