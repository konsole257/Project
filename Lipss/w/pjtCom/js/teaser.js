...
var initCanvasSlideshow1 = new CanvasSlideshow({
  sprites: ['/w/pjtCom/images/teaser/teaser1.jpg'],
  displacementImage: '/w/pjtCom/images/teaser/pattern-clouds.jpg',
  autoPlay: true,
  autoPlaySpeed: [6, 10],
  interactive: false,
...
var initCanvasSlideshow2 = new CanvasSlideshow({
  sprites: ['/w/pjtCom/images/teaser/teaser2.jpg'],
  displacementImage: '/w/pjtCom/images/teaser/pattern-clouds.jpg',
  autoPlay: true,
  autoPlaySpeed: [6, 10],
  interactive: false,
...
var initCanvasSlideshow3 = new CanvasSlideshow({
  sprites: ['/w/pjtCom/images/teaser/teaser3.jpg'],
  displacementImage: '/w/pjtCom/images/teaser/pattern-clouds.jpg',
  autoPlay: true,
  autoPlaySpeed: [6, 10],
  interactive: false,
...
var initCanvasSlideshow4 = new CanvasSlideshow({
  sprites: ['/w/pjtCom/images/teaser/teaser4.jpg'],
  displacementImage: '/w/pjtCom/images/teaser/pattern-clouds.jpg',
  autoPlay: true,
  autoPlaySpeed: [6, 10],
  interactive: false,
...
$('.wrap-canvas canvas:nth-child(1)').addClass('show');
