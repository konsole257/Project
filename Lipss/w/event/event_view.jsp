...
<body class="sub">
	...
	<!-- wrap -->
	<main id="wrap" class="event detail">
						...
						<fieldset>
							...
							<div class="write_box">
								...
								<div class="reply_bottom">
									...
									<a href="#file_upload" class="btn_img" onclick="fn.popupOpen('#file_upload');">이미지 첨부</a>
								</div>
							</div>
						</fieldset>
					</form>
					...
					<li>
						<div class="comm_con">
							...
							<figure class="attached_img">
								<img src="/w/pjtCom/images/temp/img_comment.jpg" alt="첨부 이미지">
							</figure>
						</div>
					</li>
					<!-- // 반복영역 -->
	...
	<div id="file_upload" class="popup file_upload">
		<div class="inner">
			...
			<div class="contents">
				...
				<div class="btn_area">
					<button type="submit" class="btn_ok" ><span>등록</span></button>
					<button type="button" class="btn_cancel" data-remodal-action="cancel" onclick="fn.popupClose();"><span>취소</span></button>
				</div>
			</div>
		</div>
	</div>
