...
<body class="mypage">
<div id="wrap" class="order_change">
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<label><input type="radio" name="change" class="rdo_type1" checked><span>교환신청</span></label>
							<label><input type="radio" name="change" class="rdo_type1"><span>반품신청</span></label>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" title="제목 입력" class="inp_type1" /></td>
					</tr>
					<tr>
