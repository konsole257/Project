	...
	<main id="contents">
		...
		<div class="order_area">
			<div class="top">
				...
				<div class="state">
					<a href="#" class="btn_cancel">전체주문취소</a>
					<%-- <a href="#" class="btn_change">교환/반품신청</a> --%>
				</div>
			</div>
			...
			<div class="bottom">
				...
				<div class="info_area">
					...
					<div class="total_price">&#8361; 38,000 <b class="state">구매확정<button type="button" class="btn_write">상품평작성</button></b></div>
