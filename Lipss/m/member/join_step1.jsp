		...
		<section>
			...
			<div class="area">
				...
				<div class="name_area">
					...
					<p class="txt_alert mgt12">국,영문 20자 이내 입력</p><!-- 추가 : 2018.06.07_2 -->
				</div>
				<input title="아이디 입력" placeholder="ID (숫자, 영문조합으로 6자리 이상)" type="text" class="inp_type1 mgt12" />
				...
				<div class="agree_lang kor">
					<div class="agree_cont active">
						...
						<div class="agree_body">
							...
							<br>
							<strong>제 8 조 (이용 신청의 승낙)</strong><br>
							...
							<br>
							<strong>제 9 조 (이용 계약 사항의 변경)</strong><br>
							...
							<br>
							<strong>제 3 장 구매계약</strong><br>
							<strong>제 10 조 (구매신청)</strong><br>
							...
							④ 결제방법의 선택<br>
							<br>
							<strong>제 11 조 (계약의 성립)</strong><br>
							...
							<br>
							<strong>제 4 장 대금결제</strong><br>
							<strong>제 12 조 (지급방법)</strong><br>
							...
							<br>
							<strong>제 13 조 (수신확인통지, 구매신청 변경 및 취소)</strong><br>
							...
							<br>
							<strong>제 5 장 배송, 취소, 교환, 환불</strong><br>
							<strong>제 14 조 (배송)</strong><br>
							...
							<br>
							<strong>제 15 조 (취소, 교환 및 환불)</strong><br>
							...
							<br>
							<br>
							<strong>제 6 장 계약 당사자의 의무</strong><br>
							<strong>제 16 조 (“사이트”의 의무)</strong><br>
							...
							<br>
							<br>
							<strong>제 17 조 (회원의 의무)</strong><br>
							...
							<br>
							<strong>제 7 장 서비스 제공 및 이용</strong><br>
							<strong>제 18 조 (서비스의 이용개시)</strong><br>
							...
							<br>
							<strong>제 19 조 (서비스의 이용시간)</strong><br>
							...
							<br>
							<strong>제 20 조 (요금 및 유료정보)</strong><br>
							...
							<br>
							<strong>제 21 조 (서비스 내용의 변경)</strong><br>
							...
							<br>
							<strong>제 22 조 (서비스의 제한 및 중지)</strong><br>
							...
							<br>
							<strong>제 23 조 (정보의 제공 및 광고의 게재)</strong><br>
							...
							<br>
							<strong>제 24 조 (게시물 또는 내용물의 삭제)</strong><br>
							...
							<br>
							<strong>제 25 조 (게시물의 저작권)</strong><br>
							...
							<br>
							<strong>제 8 장 계약해지 및 이용제한</strong><br>
