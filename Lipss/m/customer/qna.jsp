...
<div id="wrap" class="qna">
	...
	<script>
	// $(function(){
	// 	//로그인 안했을경우 fn.popupOpen('#loginNotice'); 호출
	// 	fn.popupOpen('#loginNotice');
	// });
	</script>
	<div id="loginNotice" class="popup loginnotice">
		<div class="popup_area">
			<div class="inner">
				...
				<main>
					<div class="txt">
						<strong><em>로그인</em>이 필요합니다.</strong>
						<p>
							로그인 상태에서 1:1 문의 등록 시 마이페이지에서 <br />
							접수 내용과 답변상태 확인이 가능합니다.<br />
							<small>(비회원의 경우 하단의 비회원 문의를 이용해 주세요.)</small>
						</p>
					</div>
					<div class="btn_area">
						<a href="#" onclick="fn.popupClose('#loginNotice');" class="btn_nonmember"><span>비회원 문의<span>Non-member QnA</span></span></a>
						<a href="/m/member/login.jsp" class="btn_login"><span>로그인<span>Login</span></span></a>
					</div>
				</main>
			</div>
		</div>
