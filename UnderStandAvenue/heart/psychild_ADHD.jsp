			...
			<section id="contents">
				...
				<div id="contents_inner">
					...
					<section id ="test_result">
						<div>
							<p class="txt1">ADHD 테스트 결과<span>입니다.</span></p>

							<p class="txt2">
								주의력결핍 과잉행동장애(ADHD: Attention deficit hyperactivity disorder)는 아이가 산만하거나 집중하지 못하는 등<br />
								과잉 행동과 충동성이 수반되는 행동 문제로 아동기에 가장 빈번하게 발생하는 문제입니다. 이 테스트는 아이의<br />
								산만함의 정도가 문제 범주에 속하는지 알아볼 수 있습니다.
							</p>
						...
						<div class="etc">
							<div class="btn_area">
								<a href="/heart/psychild_emotion.jsp" class="big type1 btn_emotion">아동 정서행동 테스트 하기</a>
					...
					<script>
					psyTest('psychild_ADHD', 5, 'single', { graph : false });
					// json파일명
					// 유형당 질문수,
