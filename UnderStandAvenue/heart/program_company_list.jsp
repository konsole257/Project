...
<body class="sub">
	...
	<main id="wrap" class="heart">
		...
		<div class="program company list">
			<!-- snb -->
			...
			<section id="contents">
				<div id="path">
					<div id="path_inner">
						...
						<a href="/heart/program_company_list.jsp"><strong>기업 프로그램</strong></a>
					</div>
				</div>

				<div id="contents_inner">
					<h2 class="con_tit">기업 프로그램</h2>

					<p class="con_tit_txt">스트레스 해소와 사회적·정서적 지지를 필요로 하는 직장인들을 위한<br />예술 기반의 맞춤형 프로그램입니다.</p>

          <!-- -->
          <p class="txt">
            만성 스트레스를 갖는 직업군, 사회적 정서적 지지를<br />
						필요로 하는 직장인들을 위한 예술힐링 프로그램과<br />
						기업 안의 건강한 문화와 조직을 형성하기 위한<br />
						Arts-based learning 프로그램을 제공합니다.
          </p>
