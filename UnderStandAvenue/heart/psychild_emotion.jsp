			...
			<section id="contents">
				...
				<div id="contents_inner">
					...
					<section id="test" class="emotion">
						...
						<div id="question">
							<table>
								<caption>아동 정서 행동 테스트 문항</caption>
					...
					<section id ="test_result">
						<div>
							<p class="txt1">아동 정서 행동 테스트 결과<span>입니다.</span></p>

							<p class="txt2">
								아동에게도 우울함과 불안감, 공격하고 싶은 마음이 있을 수 있습니다. 이 테스트는 자녀의 정서조절문제와 불안/<br />
								우울, 위축, 공격성을 측정합니다. 이유 없이 짜증을 부리고 엄마와 떨어지기 싫어하고, 친구를 때리기도 하는 등의<br />
								아동의 부적응 행동이 있는지, 있다면 그 심각성의 정도가 어떤지 알아볼 수 있습니다.
							</p>
						...
						<div class="etc">
							<div class="btn_area">
								<a href="/heart/psychild_ADHD.jsp" class="big type1 btn_adhd">ADHD 테스트 하기</a>
					...
					<script>
					psyTest('psychild_emotion', 5, 'single', { graph : true, type : 'bar' });
					// json파일명
					// 유형당 질문수,
