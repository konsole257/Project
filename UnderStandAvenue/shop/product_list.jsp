		...
		<div class="product list">
			...
			<section id="contents">
				...
				<div id="contents_inner">
					<!-- 2뎁스에선 이미지 // -->
					<h2 class="con_tit"><img src="/avenueCom/images/sub/shop_tit_clothing.gif" alt="CLOTHING"/><small><em>61</em> ITEMS</small></h2>
					<!--<h2 class="con_tit"><img src="/avenueCom/images/sub/shop_tit_bag.gif" alt="BAG & ACC"/><small><em>61</em> ITEMS</small></h2>-->
					<!--<h2 class="con_tit"><img src="/avenueCom/images/sub/shop_tit_living.gif" alt="LIVING & DINING"/><small><em>61</em> ITEMS</small></h2>-->
					<!-- 2뎁스에선 이미지 // -->

					<!-- 3뎁스에선 텍스트 // -->
					<!-- <h2 class="con_tit">DRESS<small><em>61</em> ITEMS</small></h2> -->
					<!-- // 3뎁스에선 텍스트 -->
