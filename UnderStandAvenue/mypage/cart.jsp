		...
		<div class="cart">
			...
			<section id="contents">
				...
				<div id="contents_inner">
					...
					<p class="con_tit_txt">장바구니에 저장된 제품은 <strong>30일간 보관</strong>됩니다.</p>
					<!-- -->
								...
								<form>
									<fieldset>
										...
										<table>
											...
											<thead>
												<tr>
													<th><input type="checkbox" title="전체선택" data-fn="allCheck" checked /></th>
													<!-- 2016-03-11 : 수정 // -->
													<th>상품정보</th>
													<th>상품금액</th>
													<th>수량</th>
											...
											<tbody>
												...
												<!-- 반복영역 // -->
												<tr>
													<td><input type="checkbox" title="상품 선택" checked /></td><!-- 상품 선택 -->
												...
												<tr class="delevery">
													<td colspan="7">
														...
														<span class="btn_area">
																<!-- 2016-03-11 : 삭제
																<a href="#delivery_coupon" class="small type3 btn_delivery_coupon" data-fn="popupBtnOpen">배송비 쿠폰</a>
																-->
