				...
				<div id="contents_inner">
					...
					<table class="bbs list type1">
						...
						<tbody>
							<!-- 수강신청 내역이 없을때 -->
							<tr>
								<td class="no_data" colspan="5">스테이션 상담예약 내역이 없습니다.</td>
							</tr>
							...
							<tr>
						      ...
						      <td class="subject"><a href="/mypage/apply_detail_stations.jsp">금융컨설팅</a></td>
						      <td class="lab">금융(대출) 상담</td>
							  <td class="date">2015.11.25</td>
						      <td class="state">접수중</td>
							...
							<tr>
						      <td class="number">1</td>
						      <td class="subject"><a href="#">금융컨설팅</a></td>
						      <td class="lab">금융(대출) 상담</td>
							  <td class="date">2015.11.25</td>
						      <td class="state">접수중</td>
