      ...
      <!-- snb -->
          ...
          <table class="bbs list type1">
            ...
            <tbody>
              <tr>
                <th>배송지명</th>
                <td colspan="3"><input type="text" title="배송지명 입력" id="u_subject"/></td>
              </tr>

              <tr>
                <th>주소</th>
                <td colspan="3">
                  <input title="주소 입력" id="u_address1" type="text">
									<span class="btn_area"><button class="small type4" id="btn_address" type="button">우편번호 찾기</button></span>
									<div>
										<input title="주소 입력" id="u_address2" type="text" data-blankcancel="true"><input title="주소 입력" id="u_address3" type="text" data-blankcancel="true">
									</div>
                  <div class="input_wrap default"><input type="checkbox" id="default" /><label for="default">기본배송지</label></div>
                </td>
              </tr>

              <tr>
                <th>수취인</th>
                <td colspan="3"><input type="text" title="수취인 입력" id="u_name"/></td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  <span class="input_wrap hp">
                    <input type="text" title="일반전화 앞자리 입력" id="u_tp2" maxlength="4" data-fn="nextFocus" data-type="onlyNumber" />
                  </span>
                  <span class="input_wrap hp">
                    <input type="text" title="일반전화 뒷자리 입력" id="u_tp3" maxlength="4" data-type="onlyNumber" />
                  </span>
                </td>
              </tr>
            </tbody>
          ...
          <div class="btn_area">
            <a href="#" class="midium type1 btn_register">등록</a>
