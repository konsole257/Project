			...
			allCheckBtn.click(function(){
				if ( $(this).is(':checked') ) {
					$('[type=checkbox]').each(function(){
						!$(this).is(':checked') ? $(this).prop('checked',true).trigger('change').parent().addClass('checked') : '' ;
					});
				} else {
					$('[type=checkbox]').each(function(){
						$(this).is(':checked') ? $(this).removeAttr('checked').trigger('change').parent().removeClass('checked') : '' ;
					});
				}
