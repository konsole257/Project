...
<body class="sub">
	...
	<main id="wrap" class="art">
		...
		<div class="program end list" ng-app="artProgram" ng-controller="list">
			<!-- snb -->
			...
			<section id="contents">
				<div id="path">
					<div id="path_inner">
						...
						<a href="/art/program_end_list.jsp"><strong>지난 프로그램</strong></a>
					</div>
				</div>

				<div id="contents_inner">
					<h2 class="con_tit">ART STAND</h2>
					<p class="con_tit_txt">아트스탠드의 종료 프로그램을 알려드립니다.</p>

					<!-- -->
					<div class="bbs gallery type1">
						<div>
							<!-- 반복영역 // -->
							<article  ng-repeat="program in jsonData | filter : { 'status' : 'end' } | limitTo : itemMaxLength : itemInit | orderBy : '-periodStart'">
								<a href="/art/program_end_detail.jsp?page={{pageNow}}&amp;detail={{program.index}}" class="midium type1 btn_detail"><img src="/avenueCom/images/upload/art_program/program_thumb_{{program.index}}.jpg" alt="" /></a>
								...
								<div class="btn_area">
									<a href="/art/program_end_detail.jsp?page={{pageNow}}&amp;detail={{program.index}}" class="midium type1 btn_detail">자세히보기</a>
					...
					<div class="paging">
    				<a href="/art/program_end_list.jsp?page={{pagePrev}}" class="prev">이전</a>
    				<span class="num">
    					<a ng-href="/art/program_end_list.jsp?page={{page.pageNum}}" ng-repeat="page in pageTotal | limitTo : pageMaxLength : pageInit" class="{{page.status}}"><strong>{{page.pageNum}}</strong></a>
    				</span>
    				<a href="/art/program_end_list.jsp?page={{pageNext}}" class="next">다음</a>
    			</div>
